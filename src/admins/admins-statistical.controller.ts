...
export class AdminsStatisticalController {
  ...
  @ApiOkResponse({
    ...
    schema: { example: { statusCode: 200, data: { total_users: 15230, total_wallets: 32880, total_withdraws: 1205 } } },
  })
  ...
  @ApiOkResponse({
    ...
    schema: { example: { statusCode: 200, data: { active_users_today: 920, pending_kyc: 42, queue_jobs: 5 } } },
  })
  @UseGuards(AdminJwtAuthGuard)
  @HttpCode(HttpStatus.OK)
