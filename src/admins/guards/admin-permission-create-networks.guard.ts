...
@Injectable()
export class AdminPermissionCreateNetworksGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Check permission networks:create
    ...
    if (!rolePermission) {
      throw new ForbiddenException(
        'You do not have permission to access this resource. Required: networks create permission or Super Admin role.',
      );
    }
