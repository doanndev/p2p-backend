...
@Injectable()
export class AdminPermissionUpdateForumGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!rolePermission) {
      throw new ForbiddenException(
        'You do not have permission to access this resource. Required: forum update permission or Super Admin role.',
      );
    }
