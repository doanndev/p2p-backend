...
@Injectable()
export class AdminPermissionReadNetworksGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Check permission networks:read
    ...
    if (!rolePermission) {
      throw new ForbiddenException(
        'You do not have permission to access this resource. Required: networks read permission or Super Admin role.',
      );
    }
