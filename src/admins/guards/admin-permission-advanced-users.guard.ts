...
@Injectable()
export class AdminPermissionAdvancedUsersGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Check permission users:advanced
    ...
    if (!rolePermission) {
      throw new ForbiddenException(
        'You do not have permission to access this resource. Required: users advanced permission or Super Admin role.',
      );
    }
