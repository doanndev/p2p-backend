...
@Injectable()
export class AdminPermissionReadCoinsGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!rolePermission) {
      throw new ForbiddenException(
        'You do not have permission to access this resource. Required: coins read permission or Super Admin role.',
      );
    }
