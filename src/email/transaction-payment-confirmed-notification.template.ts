...
export function getTransactionPaymentConfirmedNotificationEmailHtml(
  payload: TransactionPaymentConfirmedNotificationPayload,
): string {
  const {
    referenceCode,
    amount,
              ...
              <tr>
                <td style="background: #f5f5f7 url('${backgroundImageUrl}') no-repeat center / cover; padding: 28px 22px; border-radius: 8px;">
                  <p style="margin: 0 0 14px; color: #4a4f5f; font-size: 16px; line-height: 1.55;">
                    The buyer has marked payment as completed for this transaction.
                  </p>
                  <p style="margin: 0 0 18px; color: #4a4f5f; font-size: 16px; line-height: 1.55;">
                    Please verify funds and confirm receipt to complete the trade.
                  </p>
