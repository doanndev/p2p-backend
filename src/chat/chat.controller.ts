...
export class ChatController {
  ...
  @ApiOperation({
    ...
    description: [
      ...
      '```',
      '- Ảnh (URL http/https, upload CDN rồi gửi URL — giống support chat):',
      '```json',
      '{ "transaction_id": 123, "imageUrl": "https://cdn.example.com/proof.png" }',
      '```',
      '- Mỗi tin chỉ một trong `content` hoặc `imageUrl`.',
      '- **WS → DB**: lưu vào `chat_messages` (`type`: `text` | `image`, `content` là nội dung hoặc URL ảnh).',
